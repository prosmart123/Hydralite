...
const Footer = () => {
  return (
    <footer id="contact" className="min-h-[600px] bg-gradient-to-b from-background to-secondary relative pb-8 md:pb-0 shadow-inner">
      {/* Main Footer Content */}
      <div className="px-6 py-12 md:px-12 lg:px-12">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="border-b border-border/50 pb-16 mb-16">
            <div className="grid gap-12 lg:grid-cols-2 mb-16">
              <div className="group">
                <h3 className="text-lg font-bold uppercase tracking-widest text-foreground mb-4 flex items-center gap-2">
                  <Target className="w-5 h-5 text-primary group-hover:scale-110 transition-transform duration-300" /> Our Vision
                </h3>
              ...
              <div className="group">
                <h3 className="text-lg font-bold uppercase tracking-widest text-foreground mb-4 flex items-center gap-2">
                  <Compass className="w-5 h-5 text-primary group-hover:scale-110 transition-transform duration-300" /> Our Mission
                </h3>
                <p className="text-sm text-muted-foreground leading-relaxed max-w-xl">
            ...
            <div className="space-y-8">
              ...
              <div className="grid gap-8 md:grid-cols-3">
                <div className="space-y-2 p-4 rounded-xl glass hover:shadow-lg transition-all duration-300 hover:scale-105">
          ...
          <div className="grid gap-12 lg:grid-cols-12 mb-16">
            ...
            <div className="lg:col-span-5">
              ...
              <div className="mb-8">
                ...
                <p className="text-xs md:text-lg text-muted-foreground font-bold">
          ...
          <div className="mt-12 flex justify-center border-t border-border/50 py-6">
            <p className="text-[10px] md:text-xs uppercase tracking-[0.15em] md:tracking-[0.2em] text-muted-foreground font-bold">
              Sustainability <span className="mx-1 md:mx-3 opacity-30">•</span> Innovation <span className="mx-1 md:mx-3 opacity-30">•</span> Affordability <span className="mx-1 md:mx-3 opacity-30">•</span> Excellence
            </p>
          </div>
        </div>
      </div>
